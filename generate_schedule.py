...
.header h1 { font-size: 24px; font-weight: 800; letter-spacing: 2px; text-transform: uppercase; }
.header .subtitle { font-size: 13px; opacity: 0.85; margin-top: 6px; }
.header .update-info { font-size: 11px; opacity: 0.6; margin-top: 4px; }
...
.viewbar { background: #fff; border-bottom: 4px solid #BA0C2F; padding: 12px; display: flex; justify-content: center; gap: 8px; }
